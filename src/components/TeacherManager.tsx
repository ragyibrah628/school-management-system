    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
        <div>
          ...
          <p className="text-slate-500 mt-1">Teachers are managed from the School Management System. Here you can set weekly work limits and block unavailable slots.</p>
        </div>
        {false && !isAdding && !editingId && (
          <button
